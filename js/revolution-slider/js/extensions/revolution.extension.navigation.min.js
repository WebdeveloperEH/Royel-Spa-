      ...
      if (
        ...
        if (
          ...
          p(s) &&
            ...
            n(i, a, t.c, s, t.slideamount, "tab"),
          p(r) &&
            (e || r.width > r.min_width) &&
            n(i, a, t.c, r, t.slideamount, "thumb"),
          p(o) && e)
        ) {
          ...
          swipeStatus: function (i, n, r, o, h, p, u) {
            ...
            if (
              ...
              switch (
                ...
                case "start":
                  void 0 !== s.positionanim &&
                    ...
                    (s.slide_globaloffset =
                      "off" === s.infinity
                        ? s.slide_offset
                        : e.simp(s.slide_offset, s.maxwidth))),
                    (s.overpull = "none"),
                ...
                case "move":
                  if (
                    ((s.slide_offset =
                      "off" === s.infinity
                        ? s.slide_globaloffset + o
                        : e.simp(s.slide_globaloffset + o, s.maxwidth)),
                    "off" === s.infinity)
                  ) {
                    var b =
                    ...
                    !(0 > b || b > a.slideamount - 1)
                      ? b >= 0 &&
                        b <= a.slideamount - 1 &&
                        ((b >= 0 && o > s.overpull) ||
                          (b <= a.slideamount - 1 && o < s.overpull)) &&
                        (s.overpull = 0)
                      : (s.overpull = o),
                      (s.slide_offset =
                        0 > b
                          ? s.slide_offset +
                            (s.overpull - o) / 1.1 +
                            Math.sqrt(Math.abs((s.overpull - o) / 1.1))
                          : b > a.slideamount - 1
                          ? s.slide_offset +
                            (s.overpull - o) / 1.1 -
                            Math.sqrt(Math.abs((s.overpull - o) / 1.1))
              ...
              var j = t.parent().find(_),
                ...
                k =
                  "vertical" === S
                    ? j.find(y).first().outerHeight(!0) + T.space
              ...
              switch (n) {
                case "start":
                  t.parent().find(w).addClass("dragged"),
                    (O =
                      "vertical" === S ? L.position().top : L.position().left),
                    L.data("offset", O),
                ...
                case "move":
                  ...
                  (Q = O + o),
                    (Q =
                      Q > 0
                        ? "horizontal" === S
                          ? Q - L.width() * (((Q / L.width()) * Q) / L.width())
                          : Q -
                            L.height() * (((Q / L.height()) * Q) / L.height())
                        : Q);
                  var M =
                    "vertical" === S
                      ? 0 - (L.height() - j.height())
                  ...
                  (Q =
                    M > Q
                      ? "horizontal" === S
                        ? Q +
                          (((L.width() * (Q - M)) / L.width()) * (Q - M)) /
                            L.width()
                        : Q +
                          (((L.height() * (Q - M)) / L.height()) * (Q - M)) /
                            L.height()
                      : Q),
                    "vertical" === S
                      ? punchgs.TweenLite.set(L, { top: Q + "px" })
                      : punchgs.TweenLite.set(L, { left: Q + "px" });
                  break;
                case "end":
                case "cancel":
                  if (m)
